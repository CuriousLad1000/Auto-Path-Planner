...
# robot:
print("============ Printing robot state") #fetches the current joint state of the robot
...
status = go_to_joint_state(move_group)
print("Status:", status)
print("")


input("============ Press `Enter` to execute a movement using a pose goal ...")
status = go_to_pose_goal(move_group)
print("Status:", status)
print("")

input("============ Press `Enter` to plan and display a Cartesian path ...")
cartesian_plan, fraction = plan_cartesian_path(move_group)
#print("cartesian_plan: ", cartesian_plan)
#print("")
...
box_name=""
box_name, status = add_box(box_name, scene)


input("============ Press `Enter` to attach a Box to the Panda robot ...")
attach_box(box_name, scene, robot, eef_link, group_names)


input("============ Press `Enter` to plan and execute a path with an attached collision object ...")
cartesian_plan, fraction = plan_cartesian_path(move_group, scale=-1)
execute_plan(move_group, cartesian_plan)


input("============ Press `Enter` to detach the box from the Panda robot ...")
detach_box(box_name, scene, eef_link)


input("============ Press `Enter` to remove the box from the planning scene ...")
remove_box(box_name, scene)
